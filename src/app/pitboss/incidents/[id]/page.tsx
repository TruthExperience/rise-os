...
export default function IncidentDetailPage() {
  ...
  // Appeal decision state (steward review)
  ...
  return (
    <main className="min-h-screen bg-rise-black pb-28">
      ...
      <div className="px-4 pt-5 space-y-6">
        ...
        {/* Final Ruling — shown once resolved, and stays visible while under appeal */}
        ...
        {/* Appeal — filing UI for accused/reporter/steward, review UI for stewards */}
        {(isResolved || isAppealed) && (
          <div>
            ...
            {appeal ? (
              <div className="bg-white/5 rounded-2xl px-4 py-4 space-y-3">
                ...
                {/* Steward review panel — only while the appeal is open */}
        ...
        {/* Resolve Panel — stewards only, for the initial ruling */}
